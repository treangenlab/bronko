...
pub const DEFAULT_INDEL_WINDOW: usize = 50; //window size for indel breakpoint detection (number of neighbor log-changes)
pub const DEFAULT_INDEL_ZSCORE: f64 = 3.0; //min |z-score| of a center log-change to flag a breakpoint
pub const DEFAULT_INDEL_MIN_DEPTH: usize = 50; //min total depth at a position to consider it for a breakpoint
pub const DEFAULT_INDEL_NEIGHBOR_MAX_DEPTH: usize = 100; //at least one flanking position must have total depth under this to be a breakpoint
